    ...
    mifosX.controllers = _.extend(module, {
        ViewGroupBankAccountController: function (scope, routeParams, resourceFactory, location, route, $controller) {
            ...
            scope.delete = function () {
                resourceFactory.groupBankAccountDetailsResource.delete({ 
                    groupId: scope.groupId, 
                    bankAccountDetailAssociationId: scope.bankAccountDetailAssociationId 
                }, function (data) {
                    location.path('/groups/' + scope.groupId + '/bankaccountdetails');
                });
            };
            ...
            scope.activate = function () {
                resourceFactory.groupBankAccountDetailActivateResource.activate({ 
                    groupId: scope.groupId, 
                    bankAccountDetailAssociationId: scope.bankAccountDetailAssociationId 
                },function (data) {
                        populateDetails();
            ...
            scope.update = function () {
                ...
                scope.formData.locale = scope.optlang.code;
                resourceFactory.groupBankAccountDetailsResource.update({ 
                    groupId: scope.groupId, 
                    bankAccountDetailAssociationId: scope.bankAccountDetailAssociationId 
