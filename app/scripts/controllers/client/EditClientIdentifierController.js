(function (module) {
    mifosX.controllers = _.extend(module, {
        EditClientIdentifierController: function (scope, routeParams, location, resourceFactory, $filter) {
    ...
    mifosX.ng.application.controller('EditClientIdentifierController', ['$scope', '$routeParams', '$location', 'ResourceFactory', '$filter', mifosX.controllers.EditClientIdentifierController]).run(function ($log) {
