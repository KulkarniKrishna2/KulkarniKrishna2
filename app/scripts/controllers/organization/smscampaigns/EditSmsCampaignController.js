(function (module) {
    mifosX.controllers = _.extend(module, {
        EditSmsCampaignController: function (scope, resourceFactory, location, dateFilter, routeParams) {
    ...
    mifosX.ng.application.controller('EditSmsCampaignController', ['$scope', 'ResourceFactory', '$location', 'dateFilter', '$routeParams', mifosX.controllers.EditSmsCampaignController]).run(function ($log) {
