(function (module) {
    mifosX.controllers = _.extend(module, {
        EditOfficeTaxMappingController: function (scope, routeParams, paginatorService, resourceFactory, location, $modal) {
    ...
    mifosX.ng.application.controller('EditOfficeTaxMappingController', ['$scope', '$routeParams', 'PaginatorService', 'ResourceFactory', '$location', '$modal', mifosX.controllers.EditOfficeTaxMappingController]).run(function ($log) {
        $log.info("EditOfficeTaxMappingController initialized");
    });
}(mifosX.controllers || {}));