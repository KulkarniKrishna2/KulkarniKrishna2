(function (module) {
    mifosX.controllers = _.extend(module, {
        LoanApplicationPreApprovalActivityController: function ($controller, scope, resourceFactory, location, dateFilter, http, routeParams, API_VERSION, $upload, $rootScope, $sce, $modal,$filter) {
            ...
            scope.submitForPreApproval = function () {
                data = {};
                data.locale = "en"
                if (!_.isUndefined(scope.repaymentscheduleinfo) && !_.isUndefined(scope.repaymentscheduleinfo.loanTermsData) && !_.isUndefined(scope.repaymentscheduleinfo.loanTermsData.calculatedEmiAmount)) {
                    data.firstInstallmentAmount = scope.repaymentscheduleinfo.loanTermsData.calculatedEmiAmount;
                }
            ...
            scope.viewRepaymentDetails = function() {
                if(scope.repaymentscheduleinforepaymentscheduleinfo && scope.repaymentscheduleinfo.periods){
    ...
    mifosX.ng.application.controller('LoanApplicationPreApprovalActivityController', ['$controller','$scope', 'ResourceFactory', '$location',
        'dateFilter', '$http', '$routeParams', 'API_VERSION', '$upload', '$rootScope', '$sce', '$modal','$filter', mifosX.controllers.LoanApplicationPreApprovalActivityController]).run(function ($log) {
        $log.info("LoanApplicationPreApprovalActivityController initialized");
    });
}(mifosX.controllers || {}));
