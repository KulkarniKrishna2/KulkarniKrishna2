    ...
    mifosX.controllers = _.extend(module, {
        DeceasedDetailsActivityController: function ($controller, scope, resourceFactory, location, dateFilter, http, routeParams, API_VERSION, $upload, $rootScope, commonUtilService, $modal) {
            ...
            scope.getDeceasedDetails = function () {
                resourceFactory.deceasedDetailsResource.get({
            ...
            scope.getTemplate = function () {
                resourceFactory.deceasedDetailsTemplateResource.get({
                        clientId: scope.clientId
                    },
                    function (data) {
            ...
            scope.getDocuments = function () {
                if (scope.deceasedDetailsId) {
                    resourceFactory.documentsResource.getAllDocuments({
                            entityType: 'deceased_details',
                            entityId: scope.deceasedDetailsId
                        }, {},
                        function (data) {
                            for (var i in data) {
                                var docs = {};
            ...
            scope.submit = function () {
                ...
                if (scope.deceasedDetailsId) {
                    resourceFactory.deceasedDetailsResource.update({
                            clientId: scope.clientId,
                            deceasedDetailsId: scope.deceasedDetailsId
                        }, this.formData,
                        function (data) {
                            scope.init();
                            scope.isDeceasedDetailsCreated = true;
                    ...
                    resourceFactory.deceasedDetailsResource.save({
                            clientId: scope.clientId
                        }, this.formData,
                        function (data) {
                            scope.init();
            ...
            scope.deleteFile = function (file) {
                resourceFactory.documentsResource.delete({
                        entityType: file.parentEntityType,
                        entityId: file.parentEntityId,
                        documentId: file.id
                    }, {},
                    function (data) {
                        scope.getDocuments();
