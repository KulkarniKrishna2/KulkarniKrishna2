(function (module) {
    mifosX.controllers = _.extend(module, {
        reviewbankaccountActivityController: function (scope, resourceFactory) {
            function getBankAccountDetails() {
                resourceFactory.bankAccountDetailsResource.get({ entityType: scope.entityType, entityId: scope.entityId, bankAccountDetailsId: scope.bankAccountDetailsId }, function (data) {
                    ...
                    scope.bankhtml = 'views/bankaccountdetails/common/review_bank_account_common.html';
                });
            }
    ...
    mifosX.ng.application.controller('reviewbankaccountActivityController', ['$scope', 'ResourceFactory', mifosX.controllers.reviewbankaccountActivityController]).run(function ($log) {
